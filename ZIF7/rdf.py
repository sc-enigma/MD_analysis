...
for job_name in ['zif7_tempo_npB']: # 'zif7_tempo_lpA', 'zif7_tempo_npA', 'zif7_tempo_lpB', 'zif7_tempo_npB'
    if not os.path.exists(f'/home/sc_enigma/Projects/MD_ZIF7/analysis/rdf/{job_name}'):
        os.mkdir(f'/home/sc_enigma/Projects/MD_ZIF7/analysis/rdf/{job_name}')
